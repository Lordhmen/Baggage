...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        table.setItem(2, 0, QTableWidgetItem("Text in column 1"))
        table.setItem(2, 1, QTableWidgetItem("Text in column 2"))
        table.setItem(2, 2, QTableWidgetItem("Text in column 3"))
